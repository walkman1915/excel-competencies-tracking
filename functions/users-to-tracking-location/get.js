...
exports.lambdaHandler = async (event, context) => {
    try {
        ...
        const allUsersToTracking = await getUsersToTracking(params);
        console.log(allUsersToTracking);
        // Generate the response body for a successful get
        
        let respBody = {};
        respBody.Items = allUsersToTracking.Items; //Gets the actual items from the call
 ...
 */
function getUsersToTracking(params) {
